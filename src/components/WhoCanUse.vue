                ...
                <div class="faq-side">
                    ...
                    <div class="block-wrap">
                        <div class="faq-block left">
                            <div class="msg">
                                <span>ответ:</span>
                                <p>Клиентны получают свой проект в виде альбома в формате А3 со всеми чертежами и 3D фотографиями. </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="faq-side">
                    ...
                    <div class="block-wrap">
                        <div class="faq-block left">
                            <div class="msg">
                                <span>ответ:</span>
                                <p>Да, нашим клиентам мы предлагаем услуги строительных бригад с многолетным опытом. </p>
                            </div>
                        </div>
                    </div>
                </div>
